...
public enum ErrorCode {
    ...
    PRODUTO_INATIVO(400, "Bad Request", "Produto não pode ser excluído pois possui vendas associadas. Produto inativado."),
    ...
    INVALID_PRODUCT_STOCK(400, "Bad Request", "Estoque do produto com valor negativo ou inválido, verifique e tente novamente"),
